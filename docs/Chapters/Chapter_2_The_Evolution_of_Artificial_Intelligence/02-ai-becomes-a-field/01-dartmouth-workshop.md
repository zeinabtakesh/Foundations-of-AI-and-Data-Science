...
The Dartmouth Summer Research Project on Artificial Intelligence brought researchers together to ask whether learning, reasoning, and other aspects of intelligence could be described precisely enough for machines to reproduce them. The 1955 proposal gave this shared ambition a name: *artificial intelligence*.

[← Timeline](../index.md){ .chapter-back title="Back to chapter timeline" }

</div>

<figure class="dartmouth-photo">
  <img src="https://dartmouthalumnimagazine.com/sites/default/files/styles/hero_small/public/ai_scientists%402x.png?h=2134602a&amp;itok=1iUWq-vP" alt="Scientists from the 1956 Dartmouth AI gathering photographed together outdoors" loading="lazy">
  <figcaption>Researchers at Dartmouth in 1956. Photograph by Margaret Minsky, via <a href="https://dartmouthalumnimagazine.com/articles/birth-artificial-intelligence">Dartmouth Alumni Magazine</a>.</figcaption>
</figure>

Organized by [John McCarthy](#john-mccarthy){ data-open-details }, [Marvin Minsky](#marvin-minsky){ data-open-details }, [Nathaniel Rochester](#nathaniel-rochester){ data-open-details }, and [Claude Shannon](#claude-shannon){ data-open-details }, the project is widely treated as a starting point for AI as a named research field. It did not solve machine intelligence in one summer; it brought questions about language, problem solving, learning, and abstraction into a common research agenda.

## The organizers {#about-dartmouth-organizers}

<div class="organizer-grid">
  <details class="organizer-card" id="john-mccarthy">
  ...
  <details class="organizer-card" id="marvin-minsky">
  ...
  <details class="organizer-card" id="nathaniel-rochester">
  ...
  <details class="organizer-card" id="claude-shannon">
...
The four names belong to the **proposal's organizers**; other researchers also attended the workshop. Their affiliations are listed on the [1955 proposal](https://people.csail.mit.edu/brooks/idocs/DartmouthProposal.pdf).
